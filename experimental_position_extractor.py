...
if (__name__ == "__main__"):
  ...
  all_issues = issue_fetcher.fetch(2005, current_year, format="dict_mod")
  for year in all_issues:
    #print(year)
    #print(all_issues[year])
    extract_year(year, all_issues[year])

  
  ###############################################################################
  # This should be a list of all issue dates.
  ###############################################################################
